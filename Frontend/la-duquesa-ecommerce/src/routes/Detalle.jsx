    ...
    <>
      <div>
              ...
              <button className="mr-6 w-28 p-3 bg-[#BD6292] text-white rounded-xl">
                ...
                <div className="flex items-center space-x-4 my-4">
                  ...
                  <div className="flex-1">
                    ...
                    <img src={cronometro} alt="cronometro" className='size-10'/><h5 className='mt-2'>20 - 30 min</h5>
                    </p>
                  </div>
                </div>
        ...
        <p className="text-gray-500">
          ...
          nuestro postre es perfecto para satisfacer tus antojos de chocolate. Disfruta de cada bocado lleno de sabor y textura irresistible.
          ¡No te pierdas la oportunidad de probar nuestra exquisita torta de chocolate y endulza tus momentos especiales con nosotros!
          </p>
        </div>
